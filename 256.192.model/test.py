...
def main(args):
    ...
    with torch.no_grad():
        ...
        for i, (inputs, meta, control_points_map_label) in tqdm(enumerate(test_loader)):
            ...
            img_path = '/home/yliu/work/colab/work/fiberPJ/pytorch-cpn/256.192.model/demo_folder/worm_bi/0mask_pred_numpy.png'
            ...
            def mask_from_seeds_v3(embedding, island, mask, segments, ds, similarity_thres=0.5):
                ...
                for eachisland in np.unique(island):
                    ...
                    assignments = np.ones(len(mean_vals_numpy))
                    # import pdb; pdb.set_trace()
                    ...
                    col_ind = assignments.astype(np.uint16)
...
###################################################################
            ...
            connector_label_map_put_text = np.zeros(control_points_map_label_numpy.shape)
