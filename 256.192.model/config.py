...
class Config:
    ...
    img_dir = os.path.join(cur_dir,'/home/yliu/work/colab/work/fiberPJ/pytorch-cpn/data/synthetic/curves_pool_50_step/')
    ...
    # img_dir = os.path.join(cur_dir,'/home/yliu/work/codeToBiomix/intersection_detection/dataset/curve_coco_train_lstm_100_256_kernel_11/images/')
    # img_dir = os.path.join(cur_dir,'/home/yliu/work/codeToBiomix/intersection_detection/dataset/curve_coco_train_lstm_100_256_kernel_7/images/')
    img_dir = os.path.join(cur_dir,'/home/yliu/work/codeToBiomix/intersection_detection/dataset/curve_coco_train_lstm_100_256_kernel_3/images/')
    img_dir = os.path.join(cur_dir,'/home/yliu/work/codeToBiomix/intersection_detection/dataset/orientation_6_ave_num6curve_coco_train_lstm_2000_128_kernel_5_step_60/images/')
    img_dir = os.path.join(cur_dir,'/home/yliu/work/codeToBiomix/intersection_detection/dataset/orientation_6_ave_num6curve_coco_train_lstm_2000_128_kernel_5_step_60/images/')
    img_dir = os.path.join(cur_dir,'/home/yliu/work/codeToBiomix/intersection_detection/dataset/orientation_6_ave_num6curve_coco_train_lstm_2000_128_kernel_11_step_60/images/')
    # img_dir = os.path.join(cur_dir,'/home/yliu/work/colab/work/fiberPJ/DRIFT_Instace_segmentation_for_filaments/dataset/embedding_curve_coco_train_lstm_1000_256_kernel_5_step_30/images/')
    ...
    # gt_path = os.path.join('/home/yliu/work/codeToBiomix/intersection_detection/dataset/', 'curve_coco_train_lstm_100_256_kernel_11.json')
    # gt_path = os.path.join('/home/yliu/work/codeToBiomix/intersection_detection/dataset/', 'curve_coco_train_lstm_100_256_kernel_7.json')
    gt_path = os.path.join('/home/yliu/work/codeToBiomix/intersection_detection/dataset/', 'curve_coco_train_lstm_100_256_kernel_3.json')
    gt_path = os.path.join('/home/yliu/work/codeToBiomix/intersection_detection/dataset/', 'orientation_6_ave_num6curve_coco_train_lstm_2000_128_kernel_5_step_60.json')
    gt_path = os.path.join('/home/yliu/work/codeToBiomix/intersection_detection/dataset/', 'orientation_6_ave_num6curve_coco_train_lstm_2000_128_kernel_7_step_60.json')
    gt_path = os.path.join('/home/yliu/work/codeToBiomix/intersection_detection/dataset/', 'orientation_6_ave_num6curve_coco_train_lstm_2000_128_kernel_11_step_60.json')
