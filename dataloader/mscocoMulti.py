...
class MscocoMulti(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        # if self.is_train:
        if True:
            target15 = np.zeros((12,  int(self.out_res[0] / 8), int(self.out_res[1] / 8)))
            target11 = np.zeros((12, int(self.out_res[0] / 4), int(self.out_res[1] / 4)))
            target9 = np.zeros((12, int(self.out_res[0] / 2), int(self.out_res[1] / 2)))
            target7 = np.zeros((12, self.out_res[0], self.out_res[1]))
            ...
            target15[8, :, :] = cv2.resize(off_sets_nexts_nexts_map_h, (int(self.out_res[1] / 8),int(self.out_res[0] /8)), interpolation = cv2.INTER_NEAREST )    
            target11[8, :, :] = cv2.resize(off_sets_nexts_nexts_map_h, (int(self.out_res[1] / 4),int(self.out_res[0] /4)), interpolation = cv2.INTER_NEAREST )   
            target9[8, :, :] = cv2.resize(off_sets_nexts_nexts_map_h, (int(self.out_res[1] / 2),int(self.out_res[0] /2)), interpolation = cv2.INTER_NEAREST )   
            target7[8, :, :] = off_sets_nexts_nexts_map_h

            target15[9, :, :] = cv2.resize(off_sets_nexts_nexts_map_v, (int(self.out_res[1] / 8),int(self.out_res[0] /8)), interpolation = cv2.INTER_NEAREST )    
            target11[9, :, :] = cv2.resize(off_sets_nexts_nexts_map_v, (int(self.out_res[1] / 4),int(self.out_res[0] /4)), interpolation = cv2.INTER_NEAREST )   
            target9[9, :, :] = cv2.resize(off_sets_nexts_nexts_map_v, (int(self.out_res[1] / 2),int(self.out_res[0] /2)), interpolation = cv2.INTER_NEAREST )   
            target7[9, :, :] = off_sets_nexts_nexts_map_v

            target15[10, :, :] = cv2.resize(off_sets_prevs_prevs_map_h, (int(self.out_res[1] / 8),int(self.out_res[0] /8)), interpolation = cv2.INTER_NEAREST )    
            target11[10, :, :] = cv2.resize(off_sets_prevs_prevs_map_h, (int(self.out_res[1] / 4),int(self.out_res[0] /4)), interpolation = cv2.INTER_NEAREST )   
            target9[10, :, :] = cv2.resize(off_sets_prevs_prevs_map_h, (int(self.out_res[1] / 2),int(self.out_res[0] /2)), interpolation = cv2.INTER_NEAREST )   
            target7[10, :, :] = off_sets_prevs_prevs_map_h

            target15[11, :, :] = cv2.resize(off_sets_prevs_prevs_map_v, (int(self.out_res[1] / 8),int(self.out_res[0] /8)), interpolation = cv2.INTER_NEAREST )    
            target11[11, :, :] = cv2.resize(off_sets_prevs_prevs_map_v, (int(self.out_res[1] / 4),int(self.out_res[0] /4)), interpolation = cv2.INTER_NEAREST )   
            target9[11, :, :] = cv2.resize(off_sets_prevs_prevs_map_v, (int(self.out_res[1] / 2),int(self.out_res[0] /2)), interpolation = cv2.INTER_NEAREST )   
            target7[11, :, :] = off_sets_prevs_prevs_map_v
