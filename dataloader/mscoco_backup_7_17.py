...
class mscoco_backup_7_17(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        if True:
            ...
            target15[self.num_class - 1, :, :] = mask[:,:,0]
            target11[self.num_class - 1, :, :] = mask[:,:,0]
            target9[self.num_class - 1, :, :] = mask[:,:,0]
            target7[self.num_class - 1, :, :] = mask[:,:,0]
            # print(target7.shape)
