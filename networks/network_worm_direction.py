...
class CPN(nn.Module):
    def __init__(self, resnet, output_shape, num_class, inter=False, pretrained=True):
        ...
        self.embedNet_inter = UNet(2,1,6)
        ...
        self.unet = UNet(2, 2,4)

        # self.direction_net = UNet(2, 6,1)
    ...
    def forward(self, x):
        ...
        embed_predict, directionNet_predict = self.embedNet_inter(x)


        # directionNet_predict, _= self.direction_net(x)
